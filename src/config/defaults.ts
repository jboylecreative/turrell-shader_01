...
const BEVERAGES: BeverageMap = {
  americano: {
    ...
    structure: { structureType: "gradient", pos: 0.5, size: 0.5, angle: 270, sharpness: 0.2 },
    depth: { turbidity: 0.6, parallax: 0.5, depthTint: 0.6 },
    surface: { sheen: 0.0, iridescence: 0.0, caustics: 0.0 },
  ...
  matcha: {
    ...
    structure: { structureType: "orb", pos: 0.5, size: 0.36, angle: 0, sharpness: 0.15 },
    depth: { turbidity: 0.5, parallax: 0.4, depthTint: 0.5 },
    surface: { sheen: 0.0, iridescence: 0.0, caustics: 0.15 },
  ...
  latte: {
    ...
    surface: { sheen: 0.1, iridescence: 0.0, caustics: 0.0 },
  ...
  espresso: {
    ...
    structure: { structureType: "core", pos: 0.5, size: 0.46, angle: 0, sharpness: 0.3 },
    depth: { turbidity: 0.75, parallax: 0.4, depthTint: 0.7 },
    surface: { sheen: 0.2, iridescence: 0.0, caustics: 0.0 },
  ...
  coldBrew: {
    ...
    structure: { structureType: "field", pos: 0.5, size: 0.5, angle: 0, sharpness: 0.4 },
    depth: { turbidity: 0.4, parallax: 0.7, depthTint: 0.7 },
    surface: { sheen: 0.35, iridescence: 0.35, caustics: 0.2 },
